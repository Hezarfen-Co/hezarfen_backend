...
| GET    | `/ai/capabilities`                                               | no      | The capabilities connected AI services are serving right now, per capability, with the work in flight — a discovery read for an operator or a service deciding what it may ask this bridge to do. |
