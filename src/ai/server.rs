...
impl AiBridge {
    ...
    /// Is anything connected that can serve `capability`? Callers use this to
    /// hide a feature in the UI rather than to gate a request — by the time the
    /// request runs, the answer may have changed either way.
