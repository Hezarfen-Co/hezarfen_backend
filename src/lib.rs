...
#[openapi(
    ...
    tags(
        ...
        (name = "events", description = "Events with an audience (school-wide, one role, a course's enrollment, or a hand-picked user list — the expected-attendee roster; every event stays visible to all) and their attendance: teacher+ marks people in the audience (students never mark, not even themselves), and the roster report joins the expected list with the marks to show who missed"),
        (name = "courses", description = "Courses, enrollment (students only), course exams, and course sessions"),
